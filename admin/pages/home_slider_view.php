<?php 
  ...
  $query = "SELECT * FROM home_slider";//zzz till here
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><a href="home_slider_edit.php?id=<?php echo $row['id']; ?>">Edit</a> / <a href="home_slider_delete.php?id=<?php echo $row['id']; ?>">Delete</a></td>
                                        </tr>
                                        <?php endwhile ?>
                                    </tbody>
                                </table>
