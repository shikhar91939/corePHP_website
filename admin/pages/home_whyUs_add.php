<?php 
  ...
  if(isset($_POST['home_whyUs_add']))
  {
    $title = $_POST['title'];
    $description = $_POST['description'];
    $image_name = $_FILES['icon']['name'];
    $image_type = $_FILES['icon']['type'];
    $image_location = $_FILES['icon']['tmp_name'];
    ...
    $query_addSlider = 
    "INSERT INTO home_whyUs(`image_name`,`title`, `description`) 
    VALUES('$image_uploadName_esc', '$title_esc', '$description_esc')";
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Home > Why Us > Add</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <form role="form" method="post" enctype="multipart/form-data">
                                    ...
                                    <button name="home_whyUs_add" type="submit" class="btn btn-default">Submit</button>
                                </form>
                            </div>
                            <!-- /.col-lg-6 (nested) -->
